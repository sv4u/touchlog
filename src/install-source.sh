...
curl https://development.sasankvishnubhatla.net/log-suite/touchlog/README.md > $temp_readme
...
curl https://development.sasankvishnubhatla.net/log-suite/touchlog/src/,touchlog.c > $temp_c
curl https://development.sasankvishnubhatla.net/log-suite/touchlog/src/,touchlog.h > $temp_h
curl https://development.sasankvishnubhatla.net/log-suite/touchlog/src/Makefile > $temp_make
...
curl https://development.sasankvishnubhatla.net/log-suite/touchlog/,touchlog.1 > $temp_man
